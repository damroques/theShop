...
<div id="titre2">
 <h1>Nos patisseries</h1>
   ...
   <!-- <div id="moncadre">
     <a href="p_patisseries.php">
     <img src="patisseries.jpg"/>
     <center><b>patisseries regionales</b></center>
    >
     <a href="g_patisseries.php">
     <img src="g_patisseries.jpg">
     <center><b>patisseries orientales</b></center>
   </div> -->
   ...
   <div class="boite2">
     <a href="p_patisseries.php">
     <img src="image/patisseries.jpg"/></a>
     <h5>patisseries regionales</h5>
     </div>
     <div class="boite2">
       <a href="g_patisseries.php">
       <img src="image/pOrientales.jpg"></a>
       <h5>patisseries orientales</h5>
