...
<html>
 ...
 <body >
   ...
   <!-- <div class='container'> -->
<div id="titre2">
 <h1>patisseries regionales</h1>
 </div>
</form>
 <!-- <div id="moncadre">
<img src="patisseries2.jpg"/>
     <center><p> le sublime </p></center>
<img src="patisseries3.jpg">
     <center><p>le slurp</p></center>
   </div> -->
   <div class="moncadre">
     <div class="bboite">
   <div class="boite2">
     <a href="#">
     <img src="image/millefeuille.jpg"/></a>
     <h5>millefeuille</h5>
     </div>
     <div class="boite2">
       <a href="index.20.php">
       <img src="image/tarteauxpommes.jpg"></a>
